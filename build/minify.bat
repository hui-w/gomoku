...
type "%SRC%\canvas-ui\button.js" "%SRC%\canvas-ui\component.js" "%SRC%\canvas-ui\label.js" "%SRC%\canvas-ui\panel.js" "%SRC%\canvas-ui\polyfill.js" "%SRC%\canvas-ui\ui_manager.js" "%SRC%\app.js" "%SRC%\chessboard.js" "%SRC%\common.js" "%SRC%\config.js" "%SRC%\menu.js" "%SRC%\rule.js" "%SRC%\robot.js" "%SRC%\robot_v2.js" > "%OUT%\temp.app.js"
