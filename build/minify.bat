...
type "%SRC%\canvas-ui\button.js" "%SRC%\canvas-ui\component.js" "%SRC%\canvas-ui\label.js" "%SRC%\canvas-ui\panel.js" "%SRC%\canvas-ui\ui_manager.js" "%SRC%\app.js" "%SRC%\chessboard.js" "%SRC%\common.js" "%SRC%\config.js" "%SRC%\robot.js" > "%OUT%\temp.app.js"
